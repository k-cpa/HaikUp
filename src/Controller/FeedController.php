...
final class FeedController extends AbstractController
{
    ...
    public function __construct(LikeService $likeService, HaikusRepository $haikusRepository, LikesRepository $likesRepository) {
    ...
    #[Route('/feed/{id}/like', name: 'feed_haiku_like', methods: ['POST'])] 
        public function likeHaiku(int $id, Request $request): Response
        {
            ...
            try {
                ...
                $likesCount = $this->likesRepository->countLikes($haiku);
